    ...
    <div className="space-y-8 max-w-5xl mx-auto">
      ...
      <div className="border-b border-sentinel-border pb-6">
        <div className="flex items-center gap-3 mb-2">
          <div className="p-2.5 rounded-lg bg-sentinel-blue/10">
            <FileBarChart className="w-6 h-6 text-sentinel-blue" />
          </div>
          <div>
      ...
      {/* Report Footer */}
      <div className="text-center py-8 border-t border-sentinel-border/30">
